 ...
 * Using relative paths as the files are located in the project root.
 */
const AUDIO_HAN_SHAN_XUN = '50.随缘-lyg-寒山僧踪-埙.mp3';
const AUDIO_BODHI_HEART = '51.闲踏清凉月-梦 菩提心.mp3';
const AUDIO_GUAN_YIN = '58.悦亲-观世音.mp3';
const AUDIO_HAN_SHAN_XIAO = '64.陈伟勋-寒山僧踪 (箫).mp3';
const AUDIO_YUN_SHUI_GUZHENG = '67.木子兮-云水禅心 (古筝版).mp3';
const AUDIO_PURE_BUDDHA = '71.无畏-南无阿弥陀佛.mp3';
const AUDIO_BODHI_TREE = '59.悦亲-菩提树下.mp3';
const AUDIO_ZEN_CHIME = '66.楊李榮-寒山钟声.mp3';
...
export const QUICK_RELIEF: MeditationSession[] = [
  ...
  },
  {
    ...
    audioUrl: AUDIO_YUN_SHUI_GUZHENG,
...
export const MEDITATION_SESSIONS: MeditationSession[] = [
  ...
  },
  {
    ...
    category: 'Focus',
    imageUrl: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?auto=format&fit=crop&q=80&w=800',
    audioUrl: AUDIO_HAN_SHAN_XIAO,
    description: 'The sharp and clear tones of the bamboo flute to sharpen your mind.'
  }
];

export const AMBIENT_SOUNDS = [
  { id: 'han_shan', name: 'Han Shan Chimes', icon: '🔔', url: AUDIO_ZEN_CHIME },
  { id: 'bodhi', name: 'Bodhi Breeze', icon: '🎋', url: AUDIO_BODHI_TREE },
  { id: 'guzheng', name: 'Guzheng Stream', icon: '🎸', url: AUDIO_YUN_SHUI_GUZHENG },
  { id: 'pure_land', name: 'Pure Land Chants', icon: '📿', url: AUDIO_PURE_BUDDHA }
];